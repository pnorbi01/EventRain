    ...
    <div class="px-3 pt-3 my-3 text-start">
        ...
        <div class="list-group my-3 px-5">
            <div class="list-group-item list-group-item-action" aria-current="true">
                ...
                <a href="invite-friends-to-event.php?id=<?= $result["event_id"] ?>"><input class="btn btn-primary mb-3" type="submit" name="inviteFriend" value="Invite Friends"></a>
                <?php 
                } else {
                    if(isAuthenticated()){
                ?>
                <a href="#"><input class="btn btn-outline-primary" type="submit" name="wantToJoin" value="Want to join"></a>
                <?php
                    } else { ?>
